...
class CnaeModel extends CRUD
{
    protected $entidade = 'cnae';
    protected $id;
    protected $name;
    ...
    public function remover($id)
    {
        ...
        if (parent::editar($dados, $id)) {
            header('Location: ' . cfg::DEFAULT_URI . 'cnae/visualizar/');
        }
    }
    ...
    {
        $value = v::stringType()->notEmpty()->length(1, 60)->validate($this->getName());
        if (!$value) {
